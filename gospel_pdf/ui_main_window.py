...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 397, 384))
        ...
        self.openFileAction.setIcon(icon1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/zoomin.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/zoomout.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.zoomoutAction.setIcon(icon4)
        self.zoomoutAction.setObjectName(_fromUtf8("zoomoutAction"))
        self.prevPageAction = QtGui.QAction(window)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/prev.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.prevPageAction.setIcon(icon5)
        ...
        self.nextPageAction.setIcon(icon6)
        self.nextPageAction.setObjectName(_fromUtf8("nextPageAction"))
        self.undoJumpAction = QtGui.QAction(window)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/undo-jump.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.undoJumpAction.setIcon(icon7)
